...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped(){
        guard let username = usernameTextField.text, let password = passwordTextField.text, let confirmedPass = confirmPasswordTextField.text,
              !username.isEmpty, !password.isEmpty, !confirmedPass.isEmpty else {
            alertUserRegistrationError()
            return
        }
        guard let password = passwordTextField.text, let confirmedPass = confirmPasswordTextField.text,
