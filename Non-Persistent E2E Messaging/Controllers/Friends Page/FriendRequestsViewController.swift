...
class FriendRequestsViewController: UIViewController{
    ...
    @objc func acceptButtonTapped(_ indexPath: IndexPath) {
...
extension FriendRequestsViewController: UITableViewDelegate, UITableViewDataSource, FriendRequestTableViewCellDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let request = requests[indexPath.row]
        cell.titleLabel.text = request.sender
        
        cell.tag = indexPath.row
        
        cell.delegate = self
        
        cell.acceptButton.addTarget(self, action: #selector(FriendRequestTableViewCell.cellDenyButtonTapped), for: .touchUpInside)
